...
class Float8Tensor(torch.Tensor):
    ...
    * `_flavor`: either E4M3 or E5M2
    ...
    def __new__(cls, data, scale, scale_inv, amax):
        ...
        assert scale_inv.nelement() == 1

        assert amax.dtype == torch.float32
        assert amax.nelement() == 1
    ...
    def __repr__(self):
        return f"Float8Tensor(scale={self._scale}, scale_inv={self._scale_inv}, amax={self._amax}, as_float32={self.to_float32()}"
